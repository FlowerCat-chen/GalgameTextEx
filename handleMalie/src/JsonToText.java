...
public class JsonToText {
	static int index=-1;
		...
		public static void main(String[] args) {
			...
			String inputFolder = "/storage/emulated/0/AppProjects/机翻测试wanko/"; // 输入文件夹路径
			String outputFolder = "/storage/emulated/0/AppProjects/机翻测试wanko/out/"; // 输出文件夹路径
			String jsonFolder = "/storage/emulated/0/AppProjects/机翻测试wanko/gt_output2/";
		...
		public static void convertFile(String inputFilePath, String outputFilePath,String jsonPath) throws InterruptedException {
			try {
				...
				BufferedWriter writer = new BufferedWriter(new OutputStreamWriter(new FileOutputStream(outputFilePath), "GBK"));
